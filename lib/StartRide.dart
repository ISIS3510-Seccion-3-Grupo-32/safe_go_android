                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        fontWeight:
                            FontWeight.bold, // Peso de la fuente (opcional)
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: const Color.fromRGBO(
                          216, 244, 228, 1), // Color de fondo del icono
                      borderRadius:
                          BorderRadius.circular(60.0), // Bordes redondeados
                    ),
                    child: const Icon(Icons.access_time,
                        color: Color.fromRGBO(64, 78, 72, 1), size: 20),
                  ),
                  Padding(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              ...
                              fontWeight: FontWeight
                                  .normal, // Peso de la fuente (opcional)
                              color: Colors.black, // Color del texto (opcional)
                            ),
                          ),
                        ),
              ...
              Container(
                ...
                child: IconButton(
                  icon: const Icon(Icons.navigation,
                      color: Color.fromRGBO(64, 78, 72, 1), size: 64),
                  onPressed: () {},
                ),
              ),
            ],
